                ...
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="mt3">
                            ...
                            <input  className="input-form pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" 
                                    type="text" 
                                    name="name"  
                                    id="name"
                        ...
                        <div className="mv3">
                            ...
                            <input  className="mv2 input-form  b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" 
                                    type="password" 
                                    name="password"  
                                    id="password"
